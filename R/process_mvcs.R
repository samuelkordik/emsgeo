...
#' @param merge_distance Distance as units for the within_distance join
#'
...
process_mvcs <- function(mvcs_filename = here::here("../data/MVCs_Export.csv"),
                         ...
                         merge_distance = units::set_units(10, "m")
                         )
{
  ...
  merge_mvcs_streets(incidents_sf, streets, distance = merge_distance)
